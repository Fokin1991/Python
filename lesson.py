...
### Циклы внутри цикла верхинй диапазон  задает  то количество раз скольколо 
# в нем будет повторятся второе значение
#  то есть  "победа" будет  повторена  3 раза  а  ура внутри в каждой из побед 5




#for pobeda_counter in range(1,4):
    #for ura_counter in range(1,6):
        #print('ура')
    #print('победа')
